...
class AccountSettingActivity : AppCompatActivity() {
    ...
    private fun updateUserInfoOnly() {
        ...
        when {
            ...
            bio_profile_frag.text.toString() =="" -> {
                ...
                Log.v("name",full_name_profile_frag.text.toString())
    ...
    private fun uploadImageAndUpdateInfo() {
        ...
        when{
            ...
            full_name_profile_frag.text.toString()=="" -> Toast.makeText(this,"Please write full name first", Toast.LENGTH_LONG)
            user_name_profile_frag.text.toString() =="" -> Toast.makeText(this,"Please write user name first", Toast.LENGTH_LONG)
            bio_profile_frag.text.toString() =="" -> Toast.makeText(this,"Please write bio first", Toast.LENGTH_LONG)
            else->{
